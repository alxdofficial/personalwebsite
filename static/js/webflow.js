...
! function(t) {
    ...
    i.resize = k(u, _), i.scroll = k(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = k(), i.location = function(t) {
        ...
        h = !0, p ? (p = !1, f.each(r, v)) : f.each(o, L), f.each(a, L), i.resize.up()
    }, i.load = function(t) {
        E.then(t)
    }, i.destroy = function(t) {
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === E.state() && A()
    ...
    window.tram = function(t) {
        ...
        function u(t, e, n) {
            ...
            var i = n;
            return Y.test(t) || !Q.test(t) ? i = parseInt(t, 10) : Q.test(t) && (i = 1e3 * parseFloat(t)), 0 > i && (i = 0), i == i ? i : n
        }
        ...
        var N = e.frame = function() {
            ...
            I = l(function(e) {
                ...
                function h(t, e, i) {
                    var o, a, s, u, c = e !== p,
                        l = {};
                    for (o in t) s = t[o], o in K ? (l.transform || (l.transform = {}), l.transform[o] = s) : (g.test(o) && (o = n(o)), o in V ? l[o] = s : (u || (u = {}), u[o] = s));
                    for (o in l) {
                ...
                e.init = function(e) {
                    ...
                    $.backface && B.hideBackface && Z(this.el, $.backface.css, "hidden")
            ...
            W = l(P, function(t, e) {
                ...
                t.init = function() {
                    e.init.apply(this, arguments), this.current || (this.current = {}, K.perspective && B.perspective && (this.current.perspective = B.perspective, Z(this.el, this.name, this.style(this.current)), this.redraw()))
                }, t.set = function(t) {
            ...
            D = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (N(n), e = M(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function(t) {
                    ...
                    var n = t.from,
                        r = t.to;
                    void 0 === n && (n = i.from), void 0 === r && (r = i.to), this.unit = t.unit || "", "number" == typeof n && "number" == typeof r ? (this.begin = n, this.change = r - n) : this.format(r, n), this.value = this.begin + this.unit, this.start = M(), !1 !== t.autoplay && this.play()
                }, e.play = function() {
                    var t;
                    this.active || (this.start || (this.start = M()), this.active = !0, t = this, 1 === u.push(t) && N(n))
                }, e.stop = function() {
                    var e, n, i;
        ...
        var Z = t.style,
            ...
            V = {
                color: [q, b],
                background: [q, b, "background-color"],
                "outline-color": [q, b],
                "border-color": [q, b],
                "border-top-color": [q, b],
                "border-right-color": [q, b],
                "border-bottom-color": [q, b],
                "border-left-color": [q, b],
                "border-width": [P, y],
        ...
        $.transform && (V.transform = [W], K = {
            ...
            skewX: [E],
            skewY: [E]
        }), $.transform && $.backface && (K.z = [x, "translateZ"], K.rotateZ = [E], K.scaleZ = [w], K.perspective = [y]);
        var Y = /ms/,
            Q = /s|\./;
        return t.tram = e
    }(window.jQuery)
}, function(t, e, n) {
    n(5), n(6), n(7), n(9), n(10), n(11), n(12), n(13), n(14), t.exports = n(15)
}, function(t, e, n) {
    "use strict";
    var i = n(1)(n(2));
    ! function() {
            ...
            if (!("objectFit" in document.documentElement.style != !1) || e) {
                var n = function(t) {
                        ...
                        function(t) {
                            ...
                            for (var i in n) e.getPropertyValue(i) !== n[i] && (t.style[i] = n[i])
                    ...
                    r = function(t) {
                        if (void 0 === t || t instanceof Event) t = document.querySelectorAll("[data-object-fit]");
                            ...
                            if ("object" !== (0, i.default)(t) || !t.length || !t[0].nodeName) return !1;
                            t = t
                        }
                        for (var r = 0; r < t.length; r++)
                            if (t[r].nodeName) {
                                ...
                                if ("img" === o) {
                                    if (e) continue;
                                    t[r].complete ? n(t[r]) : t[r].addEventListener("load", function() {
                                        n(this)
                                    })
                                } else "video" === o ? t[r].readyState > 0 ? n(t[r]) : t[r].addEventListener("loadedmetadata", function() {
                                    n(this)
                                }) : n(t[r])
                            } return !0
                    };
            ...
            i.addEventListener("change", function(e) {
                ...
                if (!Webflow.env("design")) {
                    ...
                    if (r)
                        if (r.paused) {
                            var o = r.play();
                            n(i), o && "function" == typeof o.catch && o.catch(function() {
                                e(i)
                            })
                        } else r.pause(), e(i)
                }
        ...
        return {
            ready: function() {
                var t = e.WF_CLICK_EMPTY,
                    n = e.WF_CLICK_SCROLL;
                a.on(n, d, g), a.on(t, f, function(t) {
                    t.preventDefault()
    ...
    i.define("dropdown", t.exports = function(t, e) {
        ...
        function T(e, r) {
            ...
            l || (l = t.data(r, p, {
                ...
                return function() {
                    t.hovering = !1, t.links.is(":focus") || z(t)
                }
            ...
            d || (d = "w-dropdown-toggle-" + e), h || (h = "w-dropdown-list-" + e), l.toggle.attr("id", d), l.toggle.attr("aria-controls", h), l.toggle.attr("aria-haspopup", "menu"), l.toggle.attr("aria-expanded", "false"), l.toggle.find(".w-icon-dropdown-toggle").attr("aria-hidden", "true"), "BUTTON" !== l.toggle.prop("tagName") && (l.toggle.attr("role", "button"), l.toggle.attr("tabindex") || l.toggle.attr("tabindex", "0")), l.list.attr("id", h), l.list.attr("aria-labelledby", d), l.links.each(function(t, e) {
                e.hasAttribute("tabindex") || e.setAttribute("tabindex", "0"), s.test(e.hash) && e.addEventListener("click", z.bind(null, l))
            }), l.el.off(p), l.toggle.off(p), l.nav && l.nav.off(p);
            var m = R(l, a);
            n && l.el.on(L, function(t) {
                return function(e, n) {
                    n = n || {}, S(t), !0 === n.open && $(t), !1 === n.open && z(t, {
                        immediate: !0
                    })
                }
            }(l)), n || (f && (l.hovering = !1, z(l)), l.config.hover && l.toggle.on(y, function(t) {
                return function() {
                    t.hovering = !0, $(t)
                }
                ...
                return function(e) {
                    if (!n && t.open) switch (t.selectedIdx = t.links.index(document.activeElement), e.keyCode) {
                        ...
                        case o.END:
                            if (!t.open) return;
                            return t.selectedIdx = t.links.length - 1, C(t), e.preventDefault();
                        case o.ESCAPE:
                            return z(t), t.toggle.focus(), e.stopPropagation();
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                            return t.selectedIdx = Math.min(t.links.length - 1, t.selectedIdx + 1), C(t), e.preventDefault();
                        case o.ARROW_LEFT:
                        case o.ARROW_UP:
                            return t.selectedIdx = Math.max(-1, t.selectedIdx - 1), C(t), e.preventDefault()
                    }
                }
                ...
                return c(function(e) {
                    ...
                    return o || z(t), e.stopPropagation()
                })
        ...
        function R(t, e) {
            return c(function(n) {
                if (t.open || n && "w-close" === n.type) return z(t, {
                    forceClose: e
                });
                $(t)
            })
        ...
        return l.ready = O, l.design = function() {
